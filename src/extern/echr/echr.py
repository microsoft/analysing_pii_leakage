...
from src.extern.CustomBuilder import CustomECHRBuilder
from src.ner.pii_results import ListPII
...
from src.utils.random import rnd_idx
...
class CustomECHR(datasets.GeneratorBasedBuilder):
    ...
    _DESCRIPTION = "A custom wrapper for the ECHR dataset (not intended for public use)."
    _TEXT = "text"
